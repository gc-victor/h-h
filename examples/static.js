...
import { h, renderToStringIDom } from '../dist/index';
    ...
    return h('html', { lang: 'en' }, [
        h('head', {}, [
            ...
            h(
                ...
                {
                    src:
                        'https://cdn.jsdelivr.net/npm/incremental-dom@0.7.0/dist/incremental-dom-min.js',
                },
                []
            ),
        ]),
...
writeFiles('index.html', indexHtml()).then((fullPath) =>
